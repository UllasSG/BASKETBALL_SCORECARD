...
#s.grid()
homeLabel=Label(statsFrame,text='HOME')
...
fgp=Label(statsFrame,text='34'+'%')
tpp=Label(statsFrame,text='43'+'%')
tsp=Label(statsFrame,text='23'+'%')
FGLabel.grid(row=0,column=0)
TPLabel.grid(row=1,column=0)

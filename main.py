...
s=Label(statsFrame,text='TEAM STATS',font=("Helvetica", 20))
#s.grid()
homeLabel=Label(statsFrame,text='HOME',font=("Helvetica", 30))
awayLabel=Label(statsFrame,text='AWAY')
FGLabel=Label(statsFrame,text="FG%")
TPLabel=Label(statsFrame,text="3P%")
TSLabel=Label(statsFrame,text="TS%")
hfgp=Label(statsFrame,text='34'+'%')
htpp=Label(statsFrame,text='43'+'%')
htsp=Label(statsFrame,text='23'+'%')
afgp=Label(statsFrame,text='43'+'%')
atpp=Label(statsFrame,text='32'+'%')
atsp=Label(statsFrame,text='54'+'%')
homeLabel.grid(row=0,column=1)
awayLabel.grid(row=0,column=3)
FGLabel.grid(row=1,column=0)
TPLabel.grid(row=2,column=0)
TSLabel.grid(row=3,column=0)
hfgp.grid(row=1,column=1)
htpp.grid(row=2,column=1)
htsp.grid(row=3,column=1)
afgp.grid(row=1,column=3)
atpp.grid(row=2,column=3)
atsp.grid(row=3,column=3)
